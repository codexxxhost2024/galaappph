...
const Login = () => {
  ...
  const sendOtp = async () => {
    ...
    const phoneNumber = "+639123456789"; // Replace with user input
    const confirmation = await signInWithPhoneNumber(auth, phoneNumber, window.recaptchaVerifier);
    window.confirmationResult = confirmation;
  };

  return (
    <div className="flex flex-col items-center min-h-screen bg-gala-blue text-white p-6">
      <img src="/public/images/logo.png" alt="GALA Logo" className="h-16 mb-4" />
      <h1 className="text-2xl font-bold">Welcome to GALA</h1>
      <p className="text-sm text-gray-200 mb-6">Book and host properties easily</p>
